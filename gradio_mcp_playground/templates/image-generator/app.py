...
def generate_image(prompt: str, negative_prompt: str = "", steps: int = 20, seed: int = -1) -> Image.Image:
...
demo = gr.TabbedInterface(
    [text2img_interface, img2img_interface],
    ["Text to Image", "Image Variations"],
    title="{{name}}"
)
