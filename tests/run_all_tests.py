...
def main():
    ...
    test_suites = [
        {"script": test_dir / "test_cli_comprehensive.py", "name": "CLI Comprehensive Tests"},
        {"script": test_dir / "test_mcp_functionality.py", "name": "MCP Functionality Tests"},
        {"script": test_dir / "test_basic.py", "name": "Basic Unit Tests"},
    ]
